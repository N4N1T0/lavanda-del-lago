...
const WishlistBtn = ({
	product,
	className,
}: { product: Product; className?: string }): JSX.Element => {
	...
	return (
		<Heart
			...
			className={cn(
				'cursor-pointer hover:text-red-500 data-[checked=true]:text-red-500 text-gray-500 transition-colors duration-200 ease-out shrink-0 self-start',
				className,
			)}
		/>
	)
